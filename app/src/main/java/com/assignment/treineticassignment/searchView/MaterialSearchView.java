package com.assignment.treineticassignment.searchView;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void initiateView() {
        ...
        mSuggestionsListView = findViewById(R.id.suggestion_list);
        mSearchSrcTextView = findViewById(R.id.searchTextView);
        mBackBtn = findViewById(R.id.action_up_btn);
        mVoiceBtn = findViewById(R.id.action_voice_btn);
        mEmptyBtn = findViewById(R.id.action_empty_btn);
    ...
    private boolean isVoiceAvailable() {
        ...
        @SuppressLint("QueryPermissionsNeeded") List<ResolveInfo> activities = pm.queryIntentActivities(
